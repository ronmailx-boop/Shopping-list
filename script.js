...
const translations = {
    he: {
        ...
        translateBtn: '🌐 תרגם', scanReceiptTitle: 'סריקת אשראי / בנק', scanReceiptDesc: 'העלה צילום מסך מהגלריה לזיהוי עסקאות', selectImage: 'בחר תמונה', scan: 'סרוק',
    ...
    en: {
        ...
        translateBtn: '🌐 Translate', scanReceiptTitle: 'Scan Credit / Bank', scanReceiptDesc: 'Upload screenshot from gallery to detect transactions', selectImage: 'Select Image', scan: 'Scan',
    ...
    ru: {
        ...
        translateBtn: '🌐 Перевести', scanReceiptTitle: 'Сканирование Кредит / Банк', scanReceiptDesc: 'Загрузите скриншот из галереи для определения транзакций', selectImage: 'Выбрать Изображение', scan: 'Сканировать',
    ...
    ro: {
        ...
        translateBtn: '🌐 Traduce', scanReceiptTitle: 'Scanare Credit / Bancă', scanReceiptDesc: 'Încărcați captură de ecran din galerie pentru detectarea tranzacțiilor', selectImage: 'Selectează Imagine', scan: 'Scanează',
