...
function showDebugLog(logs) {
    ...
    if (!panel) {
        ...
        header.innerHTML = '<span style="color:#e94560;font-weight:bold;">🐛 Debug Log</span><div><button onclick="navigator.clipboard?.writeText(document.getElementById('debugLogContent').innerText).then(()=>alert('הועתק!'))" style="background:#0f3460;color:white;border:none;padding:3px 8px;border-radius:4px;margin-left:6px;cursor:pointer;font-size:11px;">📋 העתק</button><button onclick="document.getElementById('debugLogPanel').remove()" style="background:#e94560;color:white;border:none;padding:3px 8px;border-radius:4px;cursor:pointer;font-size:11px;">✕</button></div>';
