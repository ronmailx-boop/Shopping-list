import { CATEGORIES, CATEGORY_KEYWORDS, categoryTranslations, translations, DEMO_DATA, DEMO_NOTIFICATIONS, BANK_CONFIG, BANK_NAMES, CREDIT_NAMES, WIZ } from './constants.js';
import { currentLang, t, db, isLocked, activePage, currentEditIdx, listToDelete, sortableInstance, monthlyChart, categoryDoughnutChart, highlightedItemIndex, highlightedListId, categorySortEnabled, lastCheckedItem, lastCheckedIdx, lastCheckedState, deletedItem, deletedItemIndex, deleteTimeout, undoNotification, undoCheckNotification, undoCheckTimeout, pendingImportText, detectedListType, unsubscribeSnapshot, isSyncing, isConnected, currentUser, syncTimeout, currentNoteItemIndex, currentEditItemIndex, currentEditField, isDemoMode, setDb, setActivePage, setCurrentLang, setIsLocked, setCurrentEditIdx, setListToDelete, setSortableInstance, setMonthlyChart, setCategoryDoughnutChart, setHighlightedItemIndex, setHighlightedListId, setCategorySortEnabled, setLastCheckedItem, setLastCheckedIdx, setLastCheckedState, setDeletedItem, setDeletedItemIndex, setDeleteTimeout, setUndoNotification, setUndoCheckNotification, setUndoCheckTimeout, setPendingImportText, setDetectedListType, setUnsubscribeSnapshot, setIsSyncing, setIsConnected, setCurrentUser, setSyncTimeout, setCurrentNoteItemIndex, setCurrentEditItemIndex, setCurrentEditField, setIsDemoMode, save, exportData, importData, detectCategory, getLearnedCategory, sortItemsByStatusAndCategory, toggleItem, undoCheck, toggleSum, toggleSelectAll, toggleDarkMode, showPage, toggleCategorySorting, confirmLanguageChange, changeLanguage, updateUILanguage, updateCategoryOptions, updateModalTexts, loadDemoMode, exitDemoMode, showDemoBanner, checkFirstRunDemo, showDemoPrompt } from './store.js';
import { getReminderMilliseconds, computeNextAlertTime, formatReminderText, showDetailedError, updateCloudIndicator, normalizeItem, mergeCloudWithLocal, syncToCloud, setupFirestoreListener, initFirebaseAuth, loginWithGoogle, logoutFromCloud, startFirebaseWatcher, _forceShowAfterNotificationClick, initItemAlertTime, snoozeUrgentAlert, closeUrgentAlert, checkUrgentPayments, updateAppBadge, _scheduleAllReminders, initNotificationSystem, openCustomSnooze, applyCustomSnooze, initServiceWorkerListener, checkNotificationUrlParam, loadGithubToken, saveGithubToken, updateGithubTokenStatus, showFinProgress, hideFinProgress, setFinStage, selectedCreditCompany, selectedBank, setSelectedCreditCompany, setSelectedBank, selectCreditCompany, selectBank, runFinancialFetch, importFinancialTransactions, startCreditCardFetch, startBankFetch, checkAndScheduleNotifications, scheduleItemNotification, showInAppNotification, playNotificationSound, showItemNotification, checkSnoozeStatus } from './services.js';
import { importFromText, checkClipboardOnStartup, toggleClipboardAutoOpen, showClipboardImportModal, openManualImport, updateDetectedTypeFromInput, detectListType, changeDetectedType, acceptClipboardImport, dismissClipboardImport, importTextToList, parseAppointmentText, parseShoppingListText, parseGeneralListText, initVoiceRecognition, startVoiceInput, stopVoiceInput, parseVoiceInput, initVoiceAction, startVoiceAction, performTranslation, translateText, processReceipt, parseReceiptText, createListFromReceipt, initClipboardListeners } from './importers.js';
import { compactMode, compactActionsOpen, expandedItemIdx, listEditMode, itemEditMode, compactStatsOpen, setCompactMode, setExpandedItemIdx, setListEditMode, setItemEditMode, openModal, closeModal, showNotification, _showToast, _showLnbToast, handleLnbUndo, handleToastUndo, scrollToListTop, scrollToCheckedItems, getProductHistory, showAutocompleteSuggestions, selectAutocompleteSuggestion, hideAutocompleteSuggestions, searchInList, clearListSearch, searchInSummary, generateItemMetadataHTML, render, adjustContentPadding, initSortable, navigateMonth, getSelectedMonthKey, getMonthLabel, renderStats, renderMonthlyChart, renderCategoryDoughnutChart, renderCategoryBreakdown, renderPopularItems, renderBankData, updateNotificationBadge, dismissNotification, dismissAllNotifications, openNotificationCenter, jumpToItem, showUrgentAlertModal, goToItemFromAlert, toggleCompactStats, _restoreCompactTabs, toggleCompactMode, handleCompactPlus, closeCompactActions, toggleCompactActions, toggleListEditMode, reorderLists, setupListDrag, toggleItemEditMode, setupItemDrag, adjustListNameBarPosition, toggleListActionsPanel, openListActionsPanel, closeListActionsPanel, initListNameBarListeners, updatePlusBtnLabel, preparePrint, renderHistory, renderTemplates, showCompletedListsModal, renderCompletedLists } from './ui.js';
...
try { window.CATEGORY_KEYWORDS = CATEGORY_KEYWORDS; } catch(e) {}
try { window.categoryTranslations = categoryTranslations; } catch(e) {}
try { window.translations = translations; } catch(e) {}
try { window.DEMO_DATA = DEMO_DATA; } catch(e) {}
try { window.DEMO_NOTIFICATIONS = DEMO_NOTIFICATIONS; } catch(e) {}
try { window.BANK_CONFIG = BANK_CONFIG; } catch(e) {}
try { window.BANK_NAMES = BANK_NAMES; } catch(e) {}
try { window.CREDIT_NAMES = CREDIT_NAMES; } catch(e) {}
try { window.WIZ = WIZ; } catch(e) {}
try { window.currentLang = currentLang; } catch(e) {}
try { window.t = t; } catch(e) {}
try { window.db = db; } catch(e) {}
try { window.isLocked = isLocked; } catch(e) {}
try { window.activePage = activePage; } catch(e) {}
try { window.currentEditIdx = currentEditIdx; } catch(e) {}
try { window.listToDelete = listToDelete; } catch(e) {}
try { window.sortableInstance = sortableInstance; } catch(e) {}
try { window.monthlyChart = monthlyChart; } catch(e) {}
try { window.categoryDoughnutChart = categoryDoughnutChart; } catch(e) {}
try { window.highlightedItemIndex = highlightedItemIndex; } catch(e) {}
try { window.highlightedListId = highlightedListId; } catch(e) {}
try { window.categorySortEnabled = categorySortEnabled; } catch(e) {}
try { window.lastCheckedItem = lastCheckedItem; } catch(e) {}
try { window.lastCheckedIdx = lastCheckedIdx; } catch(e) {}
try { window.lastCheckedState = lastCheckedState; } catch(e) {}
try { window.deletedItem = deletedItem; } catch(e) {}
try { window.deletedItemIndex = deletedItemIndex; } catch(e) {}
try { window.deleteTimeout = deleteTimeout; } catch(e) {}
try { window.undoNotification = undoNotification; } catch(e) {}
try { window.undoCheckNotification = undoCheckNotification; } catch(e) {}
try { window.undoCheckTimeout = undoCheckTimeout; } catch(e) {}
try { window.pendingImportText = pendingImportText; } catch(e) {}
try { window.detectedListType = detectedListType; } catch(e) {}
try { window.unsubscribeSnapshot = unsubscribeSnapshot; } catch(e) {}
try { window.isSyncing = isSyncing; } catch(e) {}
try { window.isConnected = isConnected; } catch(e) {}
try { window.currentUser = currentUser; } catch(e) {}
try { window.syncTimeout = syncTimeout; } catch(e) {}
try { window.currentNoteItemIndex = currentNoteItemIndex; } catch(e) {}
try { window.currentEditItemIndex = currentEditItemIndex; } catch(e) {}
try { window.currentEditField = currentEditField; } catch(e) {}
try { window.isDemoMode = isDemoMode; } catch(e) {}
try { window.setDb = setDb; } catch(e) {}
try { window.setActivePage = setActivePage; } catch(e) {}
try { window.setCurrentLang = setCurrentLang; } catch(e) {}
try { window.setIsLocked = setIsLocked; } catch(e) {}
try { window.setCurrentEditIdx = setCurrentEditIdx; } catch(e) {}
try { window.setListToDelete = setListToDelete; } catch(e) {}
try { window.setSortableInstance = setSortableInstance; } catch(e) {}
try { window.setMonthlyChart = setMonthlyChart; } catch(e) {}
try { window.setCategoryDoughnutChart = setCategoryDoughnutChart; } catch(e) {}
try { window.setHighlightedItemIndex = setHighlightedItemIndex; } catch(e) {}
try { window.setHighlightedListId = setHighlightedListId; } catch(e) {}
try { window.setCategorySortEnabled = setCategorySortEnabled; } catch(e) {}
try { window.setLastCheckedItem = setLastCheckedItem; } catch(e) {}
try { window.setLastCheckedIdx = setLastCheckedIdx; } catch(e) {}
try { window.setLastCheckedState = setLastCheckedState; } catch(e) {}
try { window.setDeletedItem = setDeletedItem; } catch(e) {}
try { window.setDeletedItemIndex = setDeletedItemIndex; } catch(e) {}
try { window.setDeleteTimeout = setDeleteTimeout; } catch(e) {}
try { window.setUndoNotification = setUndoNotification; } catch(e) {}
try { window.setUndoCheckNotification = setUndoCheckNotification; } catch(e) {}
try { window.setUndoCheckTimeout = setUndoCheckTimeout; } catch(e) {}
try { window.setPendingImportText = setPendingImportText; } catch(e) {}
try { window.setDetectedListType = setDetectedListType; } catch(e) {}
try { window.setUnsubscribeSnapshot = setUnsubscribeSnapshot; } catch(e) {}
try { window.setIsSyncing = setIsSyncing; } catch(e) {}
try { window.setIsConnected = setIsConnected; } catch(e) {}
try { window.setCurrentUser = setCurrentUser; } catch(e) {}
try { window.setSyncTimeout = setSyncTimeout; } catch(e) {}
try { window.setCurrentNoteItemIndex = setCurrentNoteItemIndex; } catch(e) {}
try { window.setCurrentEditItemIndex = setCurrentEditItemIndex; } catch(e) {}
try { window.setCurrentEditField = setCurrentEditField; } catch(e) {}
try { window.setIsDemoMode = setIsDemoMode; } catch(e) {}
try { window.save = save; } catch(e) {}
try { window.exportData = exportData; } catch(e) {}
try { window.importData = importData; } catch(e) {}
try { window.detectCategory = detectCategory; } catch(e) {}
try { window.getLearnedCategory = getLearnedCategory; } catch(e) {}
try { window.sortItemsByStatusAndCategory = sortItemsByStatusAndCategory; } catch(e) {}
try { window.toggleItem = toggleItem; } catch(e) {}
try { window.undoCheck = undoCheck; } catch(e) {}
try { window.toggleSum = toggleSum; } catch(e) {}
try { window.toggleSelectAll = toggleSelectAll; } catch(e) {}
try { window.toggleDarkMode = toggleDarkMode; } catch(e) {}
try { window.showPage = showPage; } catch(e) {}
try { window.toggleCategorySorting = toggleCategorySorting; } catch(e) {}
try { window.confirmLanguageChange = confirmLanguageChange; } catch(e) {}
try { window.changeLanguage = changeLanguage; } catch(e) {}
try { window.updateUILanguage = updateUILanguage; } catch(e) {}
try { window.updateCategoryOptions = updateCategoryOptions; } catch(e) {}
try { window.updateModalTexts = updateModalTexts; } catch(e) {}
try { window.loadDemoMode = loadDemoMode; } catch(e) {}
try { window.exitDemoMode = exitDemoMode; } catch(e) {}
try { window.showDemoBanner = showDemoBanner; } catch(e) {}
try { window.checkFirstRunDemo = checkFirstRunDemo; } catch(e) {}
try { window.showDemoPrompt = showDemoPrompt; } catch(e) {}
try { window.getReminderMilliseconds = getReminderMilliseconds; } catch(e) {}
try { window.computeNextAlertTime = computeNextAlertTime; } catch(e) {}
try { window.formatReminderText = formatReminderText; } catch(e) {}
try { window.showDetailedError = showDetailedError; } catch(e) {}
try { window.updateCloudIndicator = updateCloudIndicator; } catch(e) {}
try { window.normalizeItem = normalizeItem; } catch(e) {}
try { window.mergeCloudWithLocal = mergeCloudWithLocal; } catch(e) {}
try { window.syncToCloud = syncToCloud; } catch(e) {}
try { window.setupFirestoreListener = setupFirestoreListener; } catch(e) {}
try { window.initFirebaseAuth = initFirebaseAuth; } catch(e) {}
try { window.loginWithGoogle = loginWithGoogle; } catch(e) {}
try { window.logoutFromCloud = logoutFromCloud; } catch(e) {}
try { window.startFirebaseWatcher = startFirebaseWatcher; } catch(e) {}
try { window._forceShowAfterNotificationClick = _forceShowAfterNotificationClick; } catch(e) {}
try { window.initItemAlertTime = initItemAlertTime; } catch(e) {}
try { window.snoozeUrgentAlert = snoozeUrgentAlert; } catch(e) {}
try { window.closeUrgentAlert = closeUrgentAlert; } catch(e) {}
try { window.checkUrgentPayments = checkUrgentPayments; } catch(e) {}
try { window.updateAppBadge = updateAppBadge; } catch(e) {}
try { window._scheduleAllReminders = _scheduleAllReminders; } catch(e) {}
try { window.initNotificationSystem = initNotificationSystem; } catch(e) {}
try { window.openCustomSnooze = openCustomSnooze; } catch(e) {}
try { window.applyCustomSnooze = applyCustomSnooze; } catch(e) {}
try { window.initServiceWorkerListener = initServiceWorkerListener; } catch(e) {}
try { window.checkNotificationUrlParam = checkNotificationUrlParam; } catch(e) {}
try { window.loadGithubToken = loadGithubToken; } catch(e) {}
try { window.saveGithubToken = saveGithubToken; } catch(e) {}
try { window.updateGithubTokenStatus = updateGithubTokenStatus; } catch(e) {}
try { window.showFinProgress = showFinProgress; } catch(e) {}
try { window.hideFinProgress = hideFinProgress; } catch(e) {}
try { window.setFinStage = setFinStage; } catch(e) {}
try { window.selectedCreditCompany = selectedCreditCompany; } catch(e) {}
try { window.selectedBank = selectedBank; } catch(e) {}
try { window.setSelectedCreditCompany = setSelectedCreditCompany; } catch(e) {}
try { window.setSelectedBank = setSelectedBank; } catch(e) {}
try { window.selectCreditCompany = selectCreditCompany; } catch(e) {}
try { window.selectBank = selectBank; } catch(e) {}
try { window.runFinancialFetch = runFinancialFetch; } catch(e) {}
try { window.importFinancialTransactions = importFinancialTransactions; } catch(e) {}
try { window.startCreditCardFetch = startCreditCardFetch; } catch(e) {}
try { window.startBankFetch = startBankFetch; } catch(e) {}
try { window.checkAndScheduleNotifications = checkAndScheduleNotifications; } catch(e) {}
try { window.scheduleItemNotification = scheduleItemNotification; } catch(e) {}
try { window.showInAppNotification = showInAppNotification; } catch(e) {}
try { window.playNotificationSound = playNotificationSound; } catch(e) {}
try { window.showItemNotification = showItemNotification; } catch(e) {}
try { window.checkSnoozeStatus = checkSnoozeStatus; } catch(e) {}
try { window.importFromText = importFromText; } catch(e) {}
try { window.checkClipboardOnStartup = checkClipboardOnStartup; } catch(e) {}
try { window.toggleClipboardAutoOpen = toggleClipboardAutoOpen; } catch(e) {}
try { window.showClipboardImportModal = showClipboardImportModal; } catch(e) {}
try { window.openManualImport = openManualImport; } catch(e) {}
try { window.updateDetectedTypeFromInput = updateDetectedTypeFromInput; } catch(e) {}
try { window.detectListType = detectListType; } catch(e) {}
try { window.changeDetectedType = changeDetectedType; } catch(e) {}
try { window.acceptClipboardImport = acceptClipboardImport; } catch(e) {}
try { window.dismissClipboardImport = dismissClipboardImport; } catch(e) {}
try { window.importTextToList = importTextToList; } catch(e) {}
try { window.parseAppointmentText = parseAppointmentText; } catch(e) {}
try { window.parseShoppingListText = parseShoppingListText; } catch(e) {}
try { window.parseGeneralListText = parseGeneralListText; } catch(e) {}
try { window.initVoiceRecognition = initVoiceRecognition; } catch(e) {}
try { window.startVoiceInput = startVoiceInput; } catch(e) {}
try { window.stopVoiceInput = stopVoiceInput; } catch(e) {}
try { window.parseVoiceInput = parseVoiceInput; } catch(e) {}
try { window.initVoiceAction = initVoiceAction; } catch(e) {}
try { window.startVoiceAction = startVoiceAction; } catch(e) {}
try { window.performTranslation = performTranslation; } catch(e) {}
try { window.translateText = translateText; } catch(e) {}
try { window.processReceipt = processReceipt; } catch(e) {}
try { window.parseReceiptText = parseReceiptText; } catch(e) {}
try { window.createListFromReceipt = createListFromReceipt; } catch(e) {}
try { window.initClipboardListeners = initClipboardListeners; } catch(e) {}
try { window.compactMode = compactMode; } catch(e) {}
try { window.compactActionsOpen = compactActionsOpen; } catch(e) {}
try { window.expandedItemIdx = expandedItemIdx; } catch(e) {}
try { window.listEditMode = listEditMode; } catch(e) {}
try { window.itemEditMode = itemEditMode; } catch(e) {}
try { window.compactStatsOpen = compactStatsOpen; } catch(e) {}
try { window.setCompactMode = setCompactMode; } catch(e) {}
try { window.setExpandedItemIdx = setExpandedItemIdx; } catch(e) {}
try { window.setListEditMode = setListEditMode; } catch(e) {}
try { window.setItemEditMode = setItemEditMode; } catch(e) {}
...
try { window._showToast = _showToast; } catch(e) {}
try { window._showLnbToast = _showLnbToast; } catch(e) {}
try { window.handleLnbUndo = handleLnbUndo; } catch(e) {}
try { window.handleToastUndo = handleToastUndo; } catch(e) {}
try { window.scrollToListTop = scrollToListTop; } catch(e) {}
try { window.scrollToCheckedItems = scrollToCheckedItems; } catch(e) {}
try { window.getProductHistory = getProductHistory; } catch(e) {}
try { window.showAutocompleteSuggestions = showAutocompleteSuggestions; } catch(e) {}
try { window.selectAutocompleteSuggestion = selectAutocompleteSuggestion; } catch(e) {}
try { window.hideAutocompleteSuggestions = hideAutocompleteSuggestions; } catch(e) {}
try { window.searchInList = searchInList; } catch(e) {}
try { window.clearListSearch = clearListSearch; } catch(e) {}
try { window.searchInSummary = searchInSummary; } catch(e) {}
try { window.generateItemMetadataHTML = generateItemMetadataHTML; } catch(e) {}
try { window.render = render; } catch(e) {}
try { window.adjustContentPadding = adjustContentPadding; } catch(e) {}
try { window.initSortable = initSortable; } catch(e) {}
try { window.navigateMonth = navigateMonth; } catch(e) {}
try { window.getSelectedMonthKey = getSelectedMonthKey; } catch(e) {}
try { window.getMonthLabel = getMonthLabel; } catch(e) {}
try { window.renderStats = renderStats; } catch(e) {}
try { window.renderMonthlyChart = renderMonthlyChart; } catch(e) {}
try { window.renderCategoryDoughnutChart = renderCategoryDoughnutChart; } catch(e) {}
try { window.renderCategoryBreakdown = renderCategoryBreakdown; } catch(e) {}
try { window.renderPopularItems = renderPopularItems; } catch(e) {}
try { window.renderBankData = renderBankData; } catch(e) {}
try { window.updateNotificationBadge = updateNotificationBadge; } catch(e) {}
try { window.dismissNotification = dismissNotification; } catch(e) {}
try { window.dismissAllNotifications = dismissAllNotifications; } catch(e) {}
try { window.openNotificationCenter = openNotificationCenter; } catch(e) {}
try { window.jumpToItem = jumpToItem; } catch(e) {}
try { window.showUrgentAlertModal = showUrgentAlertModal; } catch(e) {}
try { window.goToItemFromAlert = goToItemFromAlert; } catch(e) {}
try { window.toggleCompactStats = toggleCompactStats; } catch(e) {}
try { window._restoreCompactTabs = _restoreCompactTabs; } catch(e) {}
try { window.toggleCompactMode = toggleCompactMode; } catch(e) {}
try { window.handleCompactPlus = handleCompactPlus; } catch(e) {}
try { window.closeCompactActions = closeCompactActions; } catch(e) {}
try { window.toggleCompactActions = toggleCompactActions; } catch(e) {}
try { window.toggleListEditMode = toggleListEditMode; } catch(e) {}
try { window.reorderLists = reorderLists; } catch(e) {}
try { window.setupListDrag = setupListDrag; } catch(e) {}
try { window.toggleItemEditMode = toggleItemEditMode; } catch(e) {}
try { window.setupItemDrag = setupItemDrag; } catch(e) {}
try { window.adjustListNameBarPosition = adjustListNameBarPosition; } catch(e) {}
try { window.toggleListActionsPanel = toggleListActionsPanel; } catch(e) {}
try { window.openListActionsPanel = openListActionsPanel; } catch(e) {}
try { window.closeListActionsPanel = closeListActionsPanel; } catch(e) {}
try { window.initListNameBarListeners = initListNameBarListeners; } catch(e) {}
try { window.updatePlusBtnLabel = updatePlusBtnLabel; } catch(e) {}
try { window.preparePrint = preparePrint; } catch(e) {}
try { window.renderHistory = renderHistory; } catch(e) {}
try { window.renderTemplates = renderTemplates; } catch(e) {}
try { window.showCompletedListsModal = showCompletedListsModal; } catch(e) {}
try { window.renderCompletedLists = renderCompletedLists; } catch(e) {}
try { window.openDeleteCategoryModal = openDeleteCategoryModal; } catch(e) {}
try { window.executeDeleteCategory = executeDeleteCategory; } catch(e) {}
try { window.deleteCustomCategory = deleteCustomCategory; } catch(e) {}
try { window.updateCategoryDropdown = updateCategoryDropdown; } catch(e) {}
try { window.findColumnIndex = findColumnIndex; } catch(e) {}
try { window.extractPrice = extractPrice; } catch(e) {}
try { window.isDateCell = isDateCell; } catch(e) {}
try { window.handleExcelUpload = handleExcelUpload; } catch(e) {}
try { window.importBankFile = importBankFile; } catch(e) {}
try { window.importBankXLS = importBankXLS; } catch(e) {}
try { window.extractTransactionsFromSheet = extractTransactionsFromSheet; } catch(e) {}
try { window.importBankPDF = importBankPDF; } catch(e) {}
try { window.extractTransactionsFromPDFText = extractTransactionsFromPDFText; } catch(e) {}
try { window.isTotalRow = isTotalRow; } catch(e) {}
try { window.parseDate = parseDate; } catch(e) {}
try { window.formatDate = formatDate; } catch(e) {}
try { window.parseAmount = parseAmount; } catch(e) {}
try { window.saveTransactionsToFirebase = saveTransactionsToFirebase; } catch(e) {}
try { window.parseBankExcel = parseBankExcel; } catch(e) {}
try { window.parseBankPDF = parseBankPDF; } catch(e) {}
try { window.parseTransactionsFromText = parseTransactionsFromText; } catch(e) {}
try { window.addBankItemsToList = addBankItemsToList; } catch(e) {}
try { window.formatBankDate = formatBankDate; } catch(e) {}
try { window.openItemNoteModal = openItemNoteModal; } catch(e) {}
try { window.openItemNote = openItemNote; } catch(e) {}
try { window.saveItemNote = saveItemNote; } catch(e) {}
try { window.autofillFromHistory = autofillFromHistory; } catch(e) {}
try { window.updatePriceInHistory = updatePriceInHistory; } catch(e) {}
try { window.deleteFromSearchHistory = deleteFromSearchHistory; } catch(e) {}
try { window.autoLinkNotes = autoLinkNotes; } catch(e) {}
try { window.toggleItemPaid = toggleItemPaid; } catch(e) {}
try { window.editDueDate = editDueDate; } catch(e) {}
try { window.editNotes = editNotes; } catch(e) {}
try { window.enhanceItemHTML = enhanceItemHTML; } catch(e) {}
try { window.getDismissedNotifications = getDismissedNotifications; } catch(e) {}
try { window.saveDismissedNotifications = saveDismissedNotifications; } catch(e) {}
try { window.makeNotifKey = makeNotifKey; } catch(e) {}
try { window.getNotificationItems = getNotificationItems; } catch(e) {}
try { window.attachSwipeDismiss = attachSwipeDismiss; } catch(e) {}
try { window.toggleVoiceInput = toggleVoiceInput; } catch(e) {}
try { window.addItem = addItem; } catch(e) {}
try { window.createNewList = createNewList; } catch(e) {}
try { window.selectListAndImport = selectListAndImport; } catch(e) {}
try { window.clearChecked = clearChecked; } catch(e) {}
try { window.switchTab = switchTab; } catch(e) {}
try { window.updateCategoryChart = updateCategoryChart; } catch(e) {}
try { window.exportToExcel = exportToExcel; } catch(e) {}
try { window._origOpenManualImport = _origOpenManualImport; } catch(e) {}
try { window._firePushNotification = _firePushNotification; } catch(e) {}
try { window.wiz = wiz; } catch(e) {}
try { window._wizForceClose = _wizForceClose; } catch(e) {}
try { window._wizSkip = _wizSkip; } catch(e) {}
try { window._wizDismiss = _wizDismiss; } catch(e) {}
try { window._wizCloseWelcome = _wizCloseWelcome; } catch(e) {}
try { window._wizShowWelcome = _wizShowWelcome; } catch(e) {}
try { window._askDemoBeforeWizard = _askDemoBeforeWizard; } catch(e) {}
try { window.toggleWizardMode = toggleWizardMode; } catch(e) {}
try { window.handlePlusBtn = handlePlusBtn; } catch(e) {}
try { window.openWizard = openWizard; } catch(e) {}
try { window.closeWizard = closeWizard; } catch(e) {}
try { window.wizardOverlayClick = wizardOverlayClick; } catch(e) {}
try { window._fuzzyFindItem = _fuzzyFindItem; } catch(e) {}
try { window._levenshtein = _levenshtein; } catch(e) {}
try { window._stopVoiceAction = _stopVoiceAction; } catch(e) {}
try { window._updateVoiceActionBtns = _updateVoiceActionBtns; } catch(e) {}
try { window._handleVoiceActionResult = _handleVoiceActionResult; } catch(e) {}
try { window._showAddItemPrompt = _showAddItemPrompt; } catch(e) {}
try { window._addItemByVoice = _addItemByVoice; } catch(e) {}
try { window.openBankModal = openBankModal; } catch(e) {}
try { window.closeBankModal = closeBankModal; } catch(e) {}
try { window.openBankConnectModal = openBankConnectModal; } catch(e) {}
try { window.dbgLog = dbgLog; } catch(e) {}
try { window.showDebugLog = showDebugLog; } catch(e) {}
try { window._resetCompactPlusIcon = _resetCompactPlusIcon; } catch(e) {}
try { window.startBankSync = startBankSync; } catch(e) {}
try { window._positionActionsPanel = _positionActionsPanel; } catch(e) {}
try { window._positionListNameBar = _positionListNameBar; } catch(e) {}
try { window._updatePlusBtnLabel = _updatePlusBtnLabel; } catch(e) {}
try { window.categoryToDelete = categoryToDelete; } catch(e) {}
try { window.categoryIndexToDelete = categoryIndexToDelete; } catch(e) {}
try { window.checkFirebase = checkFirebase; } catch(e) {}
try { window.html = html; } catch(e) {}
try { window.originalUpdateSuggestions = originalUpdateSuggestions; } catch(e) {}
try { window.originalRender = originalRender; } catch(e) {}
try { window._reminderTimers = _reminderTimers; } catch(e) {}
try { window._origSave = _origSave; } catch(e) {}
try { window._suppressStartupModal = _suppressStartupModal; } catch(e) {}
try { window.wizardMode = wizardMode; } catch(e) {}
try { window._wizDismissCallback = _wizDismissCallback; } catch(e) {}
try { window._wizAutoTimer = _wizAutoTimer; } catch(e) {}
try { window._orig = _orig; } catch(e) {}
try { window._origOpenModal = _origOpenModal; } catch(e) {}
try { window._voiceActionRecognition = _voiceActionRecognition; } catch(e) {}
try { window._voiceActionMode = _voiceActionMode; } catch(e) {}
try { window._voiceActionActive = _voiceActionActive; } catch(e) {}
try { window._globalDebugLogs = _globalDebugLogs; } catch(e) {}
try { window._listDragAbort = _listDragAbort; } catch(e) {}
