...
import { db, setDb, save, currentUser, setCurrentUser, setIsConnected, unsubscribeSnapshot, setUnsubscribeSnapshot } from './store.js';
import { showDetailedError, mergeCloudWithLocal, normalizeItem } from './utils.js';
// ============================================================
...
export { updateCloudIndicator, syncToCloud, setupFirestoreListener, initFirebaseAuth, loginWithGoogle, logoutFromCloud, startFirebaseWatcher };
